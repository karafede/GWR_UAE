...
name_sub<-sprintf("ECMWF_%04d.%02d.",2013,01)
...
name_sub<-sprintf("ECMWF_%04d.%02d.",2014,01)
...
name_sub<-sprintf("ECMWF_%04d.%02d.",2015,01)
...
name_sub<-sprintf("ECMWF_%04d.%02d.",2016,01)
...
writeRaster(ECMWF_DUST_jan_10km, "D:/Air Quality/GWR/Saves from GWR script/ECMWF_DUST_jan_10km.tif", overwrite=TRUE)
...
writeRaster(ECMWF_SALT_jan_10km, "D:/Air Quality/GWR/Saves from GWR script/ECMWF_SALT_jan_10km.tif", overwrite=TRUE)
...
writeRaster(ECMWF_BC_jan_10km, "D:/Air Quality/GWR/Saves from GWR script/ECMWF_BC_jan_10km.tif", overwrite=TRUE)
...
writeRaster(ECMWF_OM_jan_10km, "D:/Air Quality/GWR/Saves from GWR script/ECMWF_OM_jan_10km.tif", overwrite=TRUE)
...
LU_fract_desert<- raster("desert_fraction.tif")/100
LU_fract_urban<- raster("urban_fraction.tif")/100
AOD_mean_jan<-raster("AOD_mean_jan.tif")
r_moni<- raster("in_situ_kriging_UAE.tif")
#plot(LU_fract_urban)
# ECMWF variable to form layers

ECMWF_OM_ECMWF_jan_10km<- raster("ECMWF_OM_ECMWF_jan_10km.tif")*94
ECMWF_BC_ECMWF_jan_10km<- raster("ECMWF_BC_ECMWF_jan_10km.tif")*94
ECMWF_SALT_ECMWF_jan_10km<- raster("ECMWF_SALT_ECMWF_jan_10km.tif")*94
ECMWF_DUST_ECMWF_jan_10km<- raster("ECMWF_DUST_ECMWF_jan_10km.tif")*94
ECMWF_SO4_jan_10km<- raster("ECMWF_SO4_jan_10km.tif")*94
...
bwG_pnt <- gwr.sel(BIAS ~   urban_fraction + desert_fraction + ED + ECMWF_DUST_ECMWF_jan_10km + ECMWF_SO4_jan_10km, # + ECMWF_SALT_ECMWF_jan_10km  , #+ ECMWF_SALT_ECMWF_jan_10km,# + ECMWF_SALT_ECMWF_jan_10km + ECMWF_DUST_ECMWF_jan_10km, #+ desert_fraction ++ ECMWF_DUST_ECMWF_jan_10km +ECMWF_SO4_jan_10km++    ECMWF_DUST_ECMWF_jan_10km ECMWF_DUST_ECMWF_jan_10km + ECMWF_SO4_jan_10km
                     data= combined_data_pnt_ED,  gweight = gwr.Gauss,
                   method="cv", verbose = FALSE, show.error.messages = T)

gwrG_pnt <- gwr(BIAS ~ urban_fraction + desert_fraction + ED + ECMWF_DUST_ECMWF_jan_10km + ECMWF_SO4_jan_10km ,#+ desert_fraction + ECMWF_SALT_ECMWF_jan_10km,#   , #  ECMWF_DUST_ECMWF_jan_10km ++ ECMWF_DUST_ECMWF_jan_10km + ECMWF_BC_ECMWF_jan_10km
