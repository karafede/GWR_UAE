...
plot(ECMWF_SALT_ECMWF_jan_10km)
...
bwG_pnt <- gwr.sel(BIAS ~   urban_fraction +desert_fraction + ED + ECMWF_DUST_ECMWF_jan_10km, #+ ECMWF_SALT_ECMWF_jan_10km  , #+ ECMWF_SALT_ECMWF_jan_10km,# + ECMWF_SALT_ECMWF_jan_10km + ECMWF_DUST_ECMWF_jan_10km, #+ desert_fraction ++ ECMWF_DUST_ECMWF_jan_10km +ECMWF_SO4_jan_10km++    ECMWF_DUST_ECMWF_jan_10km ECMWF_DUST_ECMWF_jan_10km + ECMWF_SO4_jan_10km
                     data= combined_data_pnt_ED,  gweight = gwr.Gauss,
                   method="cv", verbose = FALSE, show.error.messages = T)

gwrG_pnt <- gwr(BIAS ~ urban_fraction + desert_fraction + ED + ECMWF_DUST_ECMWF_jan_10km ,# + ECMWF_SALT_ECMWF_jan_10km,#   , #  ECMWF_DUST_ECMWF_jan_10km ++ ECMWF_DUST_ECMWF_jan_10km + ECMWF_BC_ECMWF_jan_10km
